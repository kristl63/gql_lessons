30.10 zprovoznění gql

7.11pip install proveden, bez comentů a spouští se

25.11 funguje voyager, crud asi take šlape, install prometheus, PlanGQLModel.py insert,update
